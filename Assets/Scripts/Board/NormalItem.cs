...
public class NormalItem : Item
{
    ...
    public static Dictionary<eNormalType, Sprite> SpriteItemData;

    public NormalItem SetType(eNormalType type)
    {
        ItemType = type;
        return this;
    }

    public override Item SetView()
    {
        base.SetView();
        viewSpriteRenderer.sprite = SpriteItemData[ItemType];
        return this;
    }

    // Factory Pattern - Normal In other Class
    protected override string GetPrefabName()
    {
        return Constants.PREFAB_NORMAL_TYPE_BASE;
